...
public class TypeData {
    ...
    public static TypeData[] makeTypeData(){
        ...
        TypeDatas[1] = new TypeData(R.drawable.hanggangic, R.drawable.hanggangpr, "한강", "한강공원에 사는 한강이는 소풍 온 사람들의 도시락 냄새를 좋아합니다. 푸른 하늘 파란 강을 가로지르는 한강이는 부드러운 배털과 친근한 성격으로 산책하는 사람들의 이목을 끌곤 합니다");
        ...
        TypeDatas[8] = new TypeData(R.drawable.sessakic, R.drawable.sessakpr, "새싹이", "전주 한옥마을에 사는 새싹이는 새싹비빔밥 냄새를 좋아합니다. 독립적인 성격의 새싹이는 해가 지면 밥짓는 냄새를 맡으며 홀로 골목골목 다니는 차가운 도시 고양이입니다.때로 대담하게 기왓장 위를 걷기도 합니다.");
